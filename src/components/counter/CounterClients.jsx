    ...
    return (
        <div ref={sectionRef} className="py-64 position-relative">
            <div className="container position-relative z-10">
                <h2 className='text-center md:text-4xl max-w-[662px] w-full mx-auto text-3xl text-lg-40 font-bold'>
                ...
                <div className="lg:mt-14 pt-3 md:pt-1 max-w-[1086px] w-full flex flex-row flex-wrap lg:flex-nowrap justify-center lg:justify-between mx-auto lg:gap-4">
                    {CLIENTS_DATA.map((item, idx) => (
                        <div key={idx} className={`flex px-3 mt-6 lg:mt-0 w-full md:w-1/2 lg:w-full lg:px-0 ${idx === 0 ? "lg:max-w-[308px]" : idx === 1 ? "lg:max-w-[322px]" : "lg:max-w-[356px]"}`}>
                            <div className={`border border-lighter-orange duration-300 ease-linear hover:border-medium-orange bg-white rounded-md min-h-[140px] gap-5 p-5 position-relative w-full flex items-center justify-center `}>
